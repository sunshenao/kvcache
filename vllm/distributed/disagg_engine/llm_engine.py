...
class SchedulerContext:
    ...
    def __init__(self, multi_step_stream_outputs: bool = False):
        ...
        self.output_queue_transfer: Deque[OutputData] = deque()
...
class LLMEngine:
    ...
    def __init__(
        ...
        from vllm.distributed.disagg_engine.scheduler import Scheduler

        self.list_lock = {
            "transfered": threading.Condition()
        }
        self.scheduler = [
            Scheduler(
    ...
    def _process_model_outputs(self,
                               ...
                               is_prefill: Optional[bool] = False) -> None:
        ...
        if is_prefill: 
            ...
            (outputs, seq_group_metadata_list, scheduler_outputs, is_async,
                ...
                skip) =  ctx.output_queue_transfer.popleft() #ctx.output_queue.popleft()
        else: 
    ...
    def step(self,is_prefill=False) -> List[Union[RequestOutput, PoolingRequestOutput]]:
        ...
        if not self._has_remaining_steps(
            ...
            if len(ctx.output_queue_transfer) > 0 and not is_prefill:
                self._process_model_outputs(ctx=ctx,is_prefill=True)
