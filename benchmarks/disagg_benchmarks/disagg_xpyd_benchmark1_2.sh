...
# Model: /root/models/Qwen/Qwen2.5-7B-Instruct-GPTQ-Int4-GPTQ-Int8
...
launch_chunked_prefill() {
  model="/root/models/Qwen/Qwen2.5-7B-Instruct-GPTQ-Int4"  # -GPTQ-Int4
  # disagg prefill
...
main() {
  ...
  benchmark $qps $default_output_len $default_input_len 1:2disagg_prefill
  done
