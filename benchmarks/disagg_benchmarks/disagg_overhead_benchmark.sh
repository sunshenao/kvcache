...
launch_disagg_prefill() {
  ...
  CUDA_VISIBLE_DEVICES=0 python3 \
    ...
    --gpu-memory-utilization 0.85 \
    --kv-transfer-config \
    '{"kv_connector":"NcclStoreConnector","kv_role":"kv_producer","kv_rank":0,"kv_parallel_size":5,"kv_buffer_size":4e9}' &
  ...
  CUDA_VISIBLE_DEVICES=1 python3 \
    ...
    --gpu-memory-utilization 0.85 \
    --kv-transfer-config \
    '{"kv_connector":"NcclStoreConnector","kv_role":"kv_producer","kv_rank":1,"kv_parallel_size":5,"kv_buffer_size":4e9}' &
    ...
    --gpu-memory-utilization 0.85 \
    --kv-transfer-config \
    '{"kv_connector":"NcclStoreConnector","kv_role":"kv_producer","kv_rank":2,"kv_parallel_size":5,"kv_buffer_size":4e9}' &
    ...
    --gpu-memory-utilization 0.85 \
    --kv-transfer-config \
    '{"kv_connector":"NcclStoreConnector","kv_role":"kv_producer","kv_rank":3,"kv_parallel_size":5,"kv_buffer_size":4e9}' &
    ...
    --gpu-memory-utilization 0.85 \
    --kv-transfer-config \
    '{"kv_connector":"NcclStoreConnector","kv_role":"kv_consumer","kv_rank":4,"kv_parallel_size":5,"kv_buffer_size":4e9}' &
